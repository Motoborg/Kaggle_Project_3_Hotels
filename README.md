...
Получен Score: 12.10508. Занял 5 место из 126, но это не чисто мои заслуги :)
Ещё есть резерв по улучшению, но в основном при применениии библиотек лексического анализа текста.
